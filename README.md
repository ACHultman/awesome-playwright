...
- [PR QA Copilot](https://github.com/ACHultman/pr-qa-copilot) - GitHub Action that runs declarative Playwright journeys and runtime checks against preview deployments, then posts evidence on pull requests.
